...
colnames(compiled_dat_2022) <- c("ts","Max_temp_F","Min_temp_F","Max_VPD_kPa","Min_VPD_kPa","Precip_in","SM_1m_m3/m3","SM_20cm_m3/m3")
compiled_dat_2022$doy <- yday(compiled_dat_2022$)
today <- Sys.time()
yday(today)
